...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-nova-slider-field', __webpack_require__(6));
    Vue.component('detail-nova-slider-field', __webpack_require__(17));
    Vue.component('form-nova-slider-field', __webpack_require__(20));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_slider_component__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_slider_component_theme_default_css__ = __webpack_require__(3);
...
var render = function() {
  ...
  return _vm.field.indexAsValue
    ...
    : _c("vue-slider", {
        ref: "slider",
        staticStyle: { cursor: "default", opacity: "1" },
        attrs: {
          tooltip: "none",
          disabled: "",
          ...
          min: _vm.field.min || 0,
          max: _vm.field.max || 100,
          interval: _vm.field.interval || 1
        },
        model: {
...
var render = function() {
  ...
  return _c(
    ...
    [
      !_vm.field.detailAsValue
        ? _c("template", { slot: "value" }, [
            _c("div", { staticClass: "flex items-center flex-wrap h-4" }, [
              _c(
                "div",
                { staticClass: "w-1/3" },
                [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_slider_component__ = __webpack_require__(1);
          ...
          [
            _c("vue-slider", {
              ...
              attrs: {
                ...
                max: _vm.field.max || 100,
                interval: _vm.field.interval || 1,
                tooltip: _vm.field.tooltip || "always",
                formatter: _vm.field.formatter || null
              },
              model: {
                value: _vm.value,
                callback: function($$v) {
